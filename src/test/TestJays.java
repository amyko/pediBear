...
public class TestJays {
	...
	public static void main(String[] args) throws IOException{
		...
		//pairwise core
		PairwiseLikelihoodCoreStreamPed core = new PairwiseLikelihoodCoreStreamPed(seqError, 1.5e-8, back, numIndiv);
		
		String fileName = "/Users/kokocakes/Google Drive/Research/pediBear/data/jays/75jays.geno0.prune10.0.1";
